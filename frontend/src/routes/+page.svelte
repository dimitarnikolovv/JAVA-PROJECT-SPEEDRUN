...
<div class="bg-gray-900">
			...
			<div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
				...
				>
					<div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
						<!-- TODO take a screenshot of the finished dashboard -->
						<img
	...
	<!-- Footer -->
	<footer class="mx-auto px-6 lg:px-8">
		<div class="border-t border-white/10 py-4 md:flex md:items-center md:justify-between">
			<p class="mt-8 text-center text-sm/6 text-gray-400 md:order-1 md:mt-0">
				&copy; 2024 Tu Rentals.
			</p>
		</div>
	</footer>
</div>
